...
- collects model training, evaluation and classification statistics like 
...
for fold in range(k):
    ...
    # Splitting data into test and train according to provided assignment
    ...
    # training statistics
    np.save(f'scores/fold{fold}_training_history.npy', history.history, allow_pickle=True)
