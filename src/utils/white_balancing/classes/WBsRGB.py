...
class WBsRGB:
  def __init__(self, gamut_mapping=2):
    self.features = np.load('src/utils/white_balancing/models/features+.npy')  # encoded features
    self.mappingFuncs = np.load('src/utils/white_balancing/models/mappingFuncs+.npy')  # correct funcs
    self.encoderWeights = np.load('src/utils/white_balancing/models/encoderWeights+.npy')  # PCA matrix
    self.encoderBias = np.load('src/utils/white_balancing/models/encoderBias+.npy')  # PCA bias
